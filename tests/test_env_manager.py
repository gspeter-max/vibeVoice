...
def test_check_and_ask_for_api_key_when_missing():
    """
    ...
    with patch("src.utils.env_manager.is_interactive", return_value=True) as mock_is_interactive, \
         patch("src.utils.env_manager.Prompt.ask") as mock_ask, \
